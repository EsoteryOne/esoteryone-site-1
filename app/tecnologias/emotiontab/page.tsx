    ...
    <main className="min-h-screen bg-[#030712] text-white">
      <div className="mx-auto max-w-6xl px-6 py-20">
        ...
        <div className="text-center">
          ...
          <p className="mt-6 mx-auto max-w-3xl text-lg text-white/60">
          ...
          <div className="mt-10 flex flex-col items-center gap-4">
            <a
              href="https://buy.stripe.com/test_3cIbJ355TciIePQ4DEaEE00"
              target="_blank"
        ...
        <div className="mt-24 rounded-2xl border border-cyan-300/20 bg-cyan-300/10 p-10 text-center backdrop-blur-xl">
          ...
          <p className="mt-4 mx-auto max-w-2xl text-cyan-100/80">
